...
import 'package:krishi_mantra/screens/widgets/custom_app_bar.dart';
...
class _NewsPageState extends State<NewsPage> {
  final List<NewsItem> featuredNews = [
    NewsItem(
      ...
      description:
          'Experts forecast good rainfall and bumper harvest this season',
  ...
  final List<NewsItem> regularNews = [
    NewsItem(
      ...
      description:
          'Scientists develop new seed types for challenging conditions',
      imageUrl: 'https://via.placeholder.com/600',
