...
class MessageRepository {
  ...
  Future<Message> sendMessage({
    ...
    try {
      final response = await _apiService.post('/api/message/send', data: {
        'userId': userId,
        'chatId': chatId,
        'content': content,
        'mediaType': mediaType,
  ...
  Future<Chat> createDirectChat({
    ...
    try {
      final response = await _apiService.post('/api/chat/direct', data: {
        'userId': userId,
        'userName': userName,
  ...
  Future<GroupChat> createGroup({
    ...
    try {
      final response = await _apiService.post('/api/group/create', data: {
        'userId': userId,
        'userName': userName,
        'name': name,
