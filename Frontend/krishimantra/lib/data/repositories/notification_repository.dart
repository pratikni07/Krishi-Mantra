...
class NotificationRepository {
  ...
  Future<Map<String, dynamic>> getUserNotifications(String userId, {int page = 1, int limit = 20}) async {
    try {
  ...
  Future<Map<String, dynamic>> createBulkNotifications(List<NotificationModel> notifications) async {
    try {
      final response = await _apiService.post(
  ...
  Future<NotificationModel> markAsRead(String userId, String notificationId) async {
    try {
